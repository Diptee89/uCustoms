...
public class FOT {
	...
	@FindBy(partialLinkText = "Final Outturn (FOT) Certificate")
	static WebElement nestedSubMenuFOT;
	// ------------------------------
	...
	@FindBy(id = "chkAckw")
	static WebElement chkAckFOT;
	@FindBy(id = "btnCreate")
	static WebElement btnCreate;
	@FindBy(xpath = "//*[@id=\"SCFinalOutturnCertificatesFr_Links_icon\"]/i")
	...
	public static void clickFOTNested(String testData) {
		try {
			nestedSubMenuFOT.click();
			OR.driver.switchTo().defaultContent();
	...
	// ------------Create
	public static void clickFOT_btn(String testData) {
		try {
	...
	public static void clickAckFOT(String testData) {
		try {
			chkAckFOT.click();
		} catch (Exception e) {
			System.out.println(e.getMessage());
