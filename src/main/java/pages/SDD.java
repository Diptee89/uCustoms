...
public class SDD {
		...
		static WebElement txtVesselType;
		// --------------Link Repository-------------
		@FindBy(xpath = "//*[@id=\"ShipDepartureDeclFr_Links_icon\"]/i")
		...
		public static void clickNewSDD(String testData) throws Exception {
			try {
		...
		public static void clickOpenSDD(String testData) throws Exception {
			try {
				OR.driver.switchTo().defaultContent();
				OR.driver.switchTo().frame("contentframe");
		...
		public static void clickDeleteSDD(String testData) throws Exception {
			try {
				OR.driver.switchTo().defaultContent();
				OR.driver.switchTo().frame("contentframe");
				chkSAD_lst.click();
	...
	public static void setJourneyNo(String testData) {
			try {	
				txtJrnNo.sendKeys(CargoImport.JourneyNo); 
		...
		public static void clickSearch_btn(String testData) {
			try {
				...
				SAD.ShipIdentificationNo = txtShpIdnNo.getText();
				SAD.ShipCallNumber = txtShipCalNo.getText();
				SAD.ShipName = txtShipName.getText();

				System.out.println("Ship Identification No: " + SAD.ShipIdentificationNo);
				System.out.println("Ship Call No: " + SAD.ShipCallNumber);
				System.out.println("Ship Call Number: " + SAD.ShipName);
		...
		public static void setNameOfMaster(String testData) {
			try {
				txtVesselType.getAttribute("value");
				System.out.println(txtVesselType.getAttribute("value"));
				JavascriptExecutor jse = (JavascriptExecutor) OR.driver;
		...
		public static void clickCreate_FAL2(String testData) {
			try {
				SAD.SADRequestNumber = txtReqNumber_SAD.getText();
				System.out.println("SAD Request Number: " + SAD.SADRequestNumber);
